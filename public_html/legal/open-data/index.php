        ...
        <section class="section">
            <div class="grid-container">
                <div class="span-8">
                    ...
                    <p style="opacity: 0.8; line-height: 1.6; margin-bottom: 3rem;">
                        If you discover personal data within Open Data, notify us via <a
                            href="<?= $basePath ?>/data/requests/" style="color:var(--accent)">/data-requests</a> and do
                        not attempt to re-identify
                        individuals.
                    </p>
